...
def index():
    ...
    projs = [
        ...
        Proj("Designing a Processor", "Design of a processor written in verilog, which supports I/O devices and instructions.","https://github.com/AbishaKugathasan/ECE243-Labs"),
        Proj("Assembly Language Programs", "Collection of projects that is written in ARM. which works on DE1-Soc Board." ,"https://github.com/AbishaKugathasan/ECE243-Labs"),
        ...
        Proj("WeGrowth", "Children's app that teaches them about the environment and resembles flappy bird","https://devpost.com/software/branched-out")
    ]
